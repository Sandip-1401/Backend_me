...
prescriptionRoute.post("/", validate(createPrescriptionSchema), asyncHandler(prescriptionController.createPrescription));
prescriptionRoute.get("/medical-record/:medicalRecordId", asyncHandler(prescriptionController.getByMedicalRecord));
